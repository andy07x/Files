...
async def start(event):
    ...
    await event.reply(
        f"ℍ𝕚 `{event.sender.first_name}`, \n𝕀 𝕒𝕞 𝕂𝕒𝕚84'𝕤 𝔹𝕠𝕥 𝕎𝕙𝕚𝕔𝕙 ℂ𝕒𝕟 𝔼𝕟𝕔𝕠𝕕𝕖 𝕍𝕚𝕕𝕖𝕠𝕤 𝕌𝕤𝕚𝕟𝕘 𝔽𝔽𝕄ℙ𝔼𝔾 𝔸𝕟𝕕 𝕆𝕥𝕙𝕖𝕣𝕤.𝕀 𝕒𝕞 𝕦𝕤𝕚𝕟𝕘 𝕒𝕟 𝕠𝕗𝕗𝕚𝕔𝕚𝕒𝕝 𝕗𝕗𝕞𝕡𝕖𝕘 𝕔𝕠𝕕𝕖 𝕦𝕤𝕖𝕕 𝕓𝕪 <a href="t.me/Kai_8_4">𝕂𝕒𝕚84</a>, ℙ𝕝𝕤 𝔻𝕠𝕟'𝕥 𝕥𝕣𝕪 𝕥𝕠 𝔼𝕟𝕔𝕠𝕕𝕖 𝔸𝕟𝕪 𝔸𝕟𝕚𝕞𝕖 𝔼𝕡𝕚𝕤𝕠𝕕𝕖𝕤 𝕆𝕥𝕙𝕖𝕣𝕨𝕚𝕤𝕖 𝕀 𝕎𝕚𝕝𝕝 𝕂𝕟𝕠𝕨 𝔸𝕟𝕕 𝔹𝕒𝕟 𝕌.",
        buttons=[
